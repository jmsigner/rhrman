...
The initial idea to develop yet an other package to analyze animal movement data was based on a review paper of home range analyses by @Laver2008. 
...
An important point raised by @Laver2008 was, that many home range studies do not sufficiently report parameter values used during analyses. 
This fits into a larger discussion hold in science on reproducible research [e.g., @rocchini2012]. 
